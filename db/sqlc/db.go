...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.deleteAaccountStmt, err = db.PrepareContext(ctx, deleteAaccount); err != nil {
		return nil, fmt.Errorf("error preparing query DeleteAaccount: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.deleteAaccountStmt != nil {
		if cerr := q.deleteAaccountStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing deleteAaccountStmt: %w", cerr)
		}
	}
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		deleteAaccountStmt: q.deleteAaccountStmt,
